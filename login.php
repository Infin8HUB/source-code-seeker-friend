...
<html>
    <head>
        ...
        <!--Dropdown Css-->
        <link rel="stylesheet" type="text/css" href="assets/msdropdown/css/msdropdown/dd.css">
...
<?php endif; ?>
        ...
        <input type="hidden" value="<?php echo isset($_REQUEST['reg']) && $_REQUEST['reg'] == '1' ? '1' : '0'; ?>" name="redirectOnReg" id="redirectOnReg" />
        <form action="" method="post">
            ...
            <!--<section class="kr-app-overview" nov="1">
                ...
                <section kr-ov-title="Converter" style="background-image:url('<?php echo APP_URL; ?>/assets/img/login/overview/1.jpg')"></section>
                <section kr-ov-title="Line Graph" style="background-image:url('<?php echo APP_URL; ?>/assets/img/login/overview/2.jpg')"></section>
                <section kr-ov-title="Candlestick Graph" style="background-image:url('<?php echo APP_URL; ?>/assets/img/login/overview/3.jpg')"></section>
                <section kr-ov-title="Market List" style="background-image:url('<?php echo APP_URL; ?>/assets/img/login/overview/4.jpg')"></section>
...
?>
    ...
    <script src="<?php echo APP_URL; ?>/assets/msdropdown/js/msdropdown/jquery.dd.js?v=1.0"></script>
    <?php

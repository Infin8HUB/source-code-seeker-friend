      ...
      foreach ($Balance->_getBalanceList() as $BalanceItem) {
        if($App->_getBalanceEstimationShown()){
          $BalanceReturned[] = [
            ...
            'balance_single' => $Balance->getBalanceByCoin(strtoupper($_SESSION['currency_name'])) * 100,
...
//        $ReturnedValue = $Balance->getBalanceByCoin(strtoupper($_SESSION['currency_name']));
      } else {

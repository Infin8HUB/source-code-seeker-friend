...
try {
    ...
    foreach (['kr_widthdraw_symbol', 'kr_widthdraw_amount'] as $fieldWidth) {
...
//    }
    ...
    $Balance->_askWidthdraw($_POST['kr_widthdraw_symbol'], $_POST['kr_widthdraw_amount']);

    die(json_encode([
      'error' => 0,
      'msg' => $Lang->tr('Your withdraw request successfully accepted.')
    ]));

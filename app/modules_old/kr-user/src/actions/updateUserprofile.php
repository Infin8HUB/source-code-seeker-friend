...
try {
    ...
    if(isset($_POST['kr_usr_phone_number']) && !empty($_POST['kr_usr_phone_number'])){
      $User->_setPhone(htmlspecialchars($_POST['kr_usr_phone_number'], ENT_QUOTES, 'UTF-8'));
    }
    
    if(isset($_POST['kr_usr_country']) && !empty($_POST['kr_usr_country'])){
      $User->_setCountry(htmlspecialchars($_POST['kr_usr_country'], ENT_QUOTES, 'UTF-8'));
    }

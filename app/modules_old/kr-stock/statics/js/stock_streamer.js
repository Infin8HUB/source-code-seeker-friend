...
//        console.log("[kr-watchinglistpair='" + market + ":" + symbol + "/" + currency + "']");
        ...
        if($('.left_info_'+symbol).length){
            $('.left_info_'+symbol).find('.kr-infoscurrencylf-price-cp_stock').html(value.price.toFixed(2));
            $('.left_info_'+symbol).find('.kr-infoscurrencylf-price-evolv').html(value.changeRelative.toFixed(2) + " ("+value.changePercentage.toFixed(2)+'%'+")");
            if(value.increase){
                $('.left_info_'+symbol).find('.kr-infoscurrencylf-price-evolv').css('color', 'green');
            } else {
                $('.left_info_'+symbol).find('.kr-infoscurrencylf-price-evolv').css('color', 'red');
            }
        }
    }

...
//          $resList[$symbol] = $vConv * $value;
          $resList[$symbol] = round($vConv * $value, 6);
        }
        return $resList;
    ...
    public function _getListCurrencyUser($User){
      ...
      $s = json_decode('{ "coins": { "BTC": { "name": "Bitcoin", "value": 1 }, "ETH": { "name": "Etherum", "value": 0 }, "EUR": { "name": "Euro", "value": 0 }, "USDT": { "name": "USDT", "value": 0 }, "LTC": { "name": "Litecoin", "value": 0 } } }', true);

...
class Usstock extends Exchange  {

  private $Api = null;

  public function __construct($User, $App, $Credentials = null){
    parent::__construct($User, $App, $this, $Credentials);
    parent::_setExchangeName('usstock');
  }

  public function _getName(){ return 'Usstock'; }
  public function _getTable(){ return 'usstock_krypto'; }
  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\binance([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials["key_usstock"]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials["secret_usstock"])
      ]);
    } else {
      $this->Api = new \ccxt\binance([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->_isActivated()['key_usstock']),
        'secret' => App::encrypt_decrypt('decrypt', $this->_isActivated()['secret_usstock'])
      ]);
    }
  ...
  public function _getPriceTrade($pair = null){
      if($pair != null){
          ...
          $currency = (isset($pairData[1])) ? $pairData[1] : 'USDT';
          if($symbol == null) return null;
          $CryptoApi = new CryptoApi(null, $currency, $App, 'US_STOCK');

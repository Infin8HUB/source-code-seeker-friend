...
//  if(isset($_POST['market']) && )
  $CryptoApi = new CryptoApi($User, [$_POST['currency'], '$'], $App, $_POST['market']);
  $Coin = new CryptoCoin($CryptoApi, $_POST['symb'], null, $_POST['market'] );

//  $CoinPrice = $Coin->_getPrice();
  $CoinPrice = $Coin->_getCoinPrice($_POST['currency'] ,$Coin->_getSymbol());
